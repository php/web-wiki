 ...
 */
class syntax_plugin_hcalendar_hcali extends DokuWiki_Syntax_Plugin {
  ...
  function getInfo(){
    return array(
		 ...
		 'date'   => '2008-01-20',
		 'name'   => 'HCalendar HCali Plugin',
		 'desc'   => 'Adds a inline HCalendar Items 
                     syntax: {{hcali>yyyy/mm/dd[hh:mm:ss];yyyy/mm/dd[hh:mm:ss]|summary|location}}
See: http://microformats.org/wiki/',
  ...
  function connectTo($mode) { 
    $this->Lexer->addSpecialPattern('{{hcali>[^}]*?}}',$mode,'plugin_hcalendar_hcali'); 
  }
  ...
  function render($mode, &$renderer, $data) {
    ...
    if ($this->getConf('filterinlinedate') == true) {
